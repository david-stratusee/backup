...
hi Visual         ctermfg=12 ctermbg=7 guifg=#ffffff guibg=#335EA8   gui=NONE
hi Comment        ctermfg=1           guifg=#008000                 gui=NONE     
hi String         ctermfg=5           guifg=#A31515                 gui=NONE
hi Constant       ctermfg=2           guifg=#0000ff                 gui=NONE    
hi Error          ctermfg=5 ctermbg=11 guifg=#ffffff guibg=#A31515   gui=NONE    
hi ErrorMsg       ctermfg=5 ctermbg=11 guifg=#ffffff guibg=#A31515   gui=NONE
hi Search         ctermfg=1 ctermbg=7 guifg=#ffffff guibg=#335EA8   gui=NONE    
hi Directory      ctermfg=2           guifg=#0000ff                 gui=NONE
hi Todo           ctermfg=5 ctermbg=11 guifg=#ffffff guibg=#A31515   gui=NONE
