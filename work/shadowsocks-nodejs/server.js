...
(function() {
  var Encryptor, KEY, LOCAL_ADDRESS, METHOD, PORT, WebSocket, WebSocketServer, config, configContent, configFile, configFromArgs, fs, http, inetNtoa, k, net, options, parseArgs, path, server, timeout, v, wss, _ref, util, wstream;
  ...
  //wstream = fs.createWriteStream(process.env.OPENSHIFT_REPO_DIR + 'shadowsocks.log', {flags : 'w'});
  wstream = fs.createWriteStream('/tmp/shadowsocks.log', {flags : 'w'});

  var log_stdout = process.stdout;
  console.log = function(d) {
      wstream.write(util.format(d) + '\n');
      //log_stdout.write(util.format(d) + '\n');
  };

  console.warn = function(d) {
      wstream.write("[WARN]" + util.format(d) + '\n');
  ...
  console.log("get method: " + METHOD.toLowerCase() + ", key: " + KEY);
